...
import { AutoComplete, ConfigProvider, Pagination, Skeleton } from "antd";
      ...
      <div className="w-full min-h-screen bg-slate-50 py-5">
        <div className="w-full p-2 md:w-[95%] lg:w-[70%] mx-auto min-h-screen bg-white">
          ...
          <div className="mt-10 w-full">
            ...
            <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:p-5  ">
...
const CompanySearchCard = ({ data }) => {
  ...
  return (
    <div className="w-full h-[130px] md:h-[150px] rounded-lg flex justify-between items-center cursor-pointer border border-gray-300 p-4 primary-shadow-hover relative hover:scale-[1.0002] "
    onClick={()=>navigate(`/user/company/${company_id}`)}>
      ...
      <div>
        ...
        <h6 className="text-[0.8rem] font-extralight mb-0">
          No of Post :{" "}
          {job_details.jobs
            ? job_details?.jobs?.length + project_details?.projects?.length
            : 0}
        </h6>
        <h6 className="text-[0.8rem] font-extralight mb-0">
