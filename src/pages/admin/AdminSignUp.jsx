...
function AdminSignUp() {
  ...
  const AdminSignUpMutation = useMutation({
    ...
    mutationFn: async (values) => {
      const res = await axiosInstance.post("/admin/signup", values);
      return res.data;
    },
    onSuccess: (data) => {
      ...
      <Formik
        ...
        onSubmit={(values) => {
          const newValues = {
            ...
            AdminSignUpMutation.mutate(newValues);
        }}
      >
        {({ handleChange, handleBlur, values, touched, errors, isValid }) => (
          <Form className="bg-white w-[90%] md:w-[400px] shadow-lg shadow-black rounded-lg p-2 px-4 md:px-6">
            ...
            <p className="m-2 text-center text-gray-400 text-sm">
              ...
              <a href="/admin/login" className="text-black text-[1rem] hover:underline">
                Login
              </a>
            </p>
          </Form>
