...
const SearchJobCard = ({ data }) => {
  ...
  return (
    <div onClick={()=>alert(data.id)} className="w-full mx-auto md:w-[80%] h-fit flex flex-col items-start p-2 md:p-5 bg-white border-gray rounded-2xl relative cursor-pointer primary-shadow-hover">
      {isNew && (
